...
if (!$company) {
    ...
    echo "Created default Company ID: {$company->id}\n";
} else {
    echo "Using existing Company ID: {$company->id}\n";
}
...
if (!$tariff) {
    ...
    echo "Created default Tariff ID: {$tariff->id}\n";
} else {
    echo "Using existing Tariff ID: {$tariff->id}\n";
}
